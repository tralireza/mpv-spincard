...
local a = I.identify("/media/TV/Breaking.Bad/Season.1/Breaking.Bad.S01E01.Pilot.mkv")
...
local b2 = I.identify("/media/TV/Some.Show/Some.Show.3x07.mkv")
...
local b4 = I.identify("/media/TV/Show/Show.S12E34.mkv")
...
local d = I.identify("/media/Movies/Some.Film.2020.1920x1080.mkv")
